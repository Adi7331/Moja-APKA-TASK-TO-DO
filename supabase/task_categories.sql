-- Uruchom ten plik w Supabase SQL Editor przed wydaniem wersji z kategoriami.
-- Nie usuwa ani nie zmienia istniejących zadań: ich category_id pozostaje NULL
-- i aplikacja pokaże je w sekcji „Bez kategorii”.
